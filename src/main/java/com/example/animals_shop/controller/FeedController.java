...
import com.example.animals_shop.repository.ForDogFeedRepository;
import com.example.animals_shop.repository.ForKatFeedRepository;
import com.example.animals_shop.repository.OtherFeedRepository;
...
public class FeedController {
    ...
    @PostMapping("/addFeed")
    public String addFeed(@ModelAttribute Feed feed, @RequestParam("picture") MultipartFile file,
    ...
    public String userAddFeed(@ModelAttribute Feed feed, @RequestParam("picture") MultipartFile file,
                              @AuthenticationPrincipal SpringUser springUser) throws IOException {
        addFeedHelper(feed, file, springUser);
        return "redirect:/user/addFeedPage";
    }

//    private void addFeedHelper(Feed feed, SpringUser springUser, MultipartFile[] files) throws IOException {
...
//    }
    ...
    private void addFeedHelper(Feed feed, MultipartFile file, SpringUser springUser) throws IOException {
        String fileName = System.currentTimeMillis() + "_" + file.getOriginalFilename();
        File picture = new File("C:\\Users\\Mariam\\IdeaProjects\\new\\animal_shop\\images\\feed_files\\" + fileName);
